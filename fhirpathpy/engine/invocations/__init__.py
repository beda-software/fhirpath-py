...
invocations = {
    ...
    "indexOf": {"fn": strings.index_of, "arity": {1: ["String"]}},
    "substring": {
        "fn": strings.substring,
        "arity": {1: ["Integer"], 2: ["Integer", "Integer"]},
    },
    "startsWith": {"fn": strings.starts_with, "arity": {1: ["String"]}},
    "endsWith": {"fn": strings.ends_with, "arity": {1: ["String"]}},
    "contains": {"fn": strings.contains_fn, "arity": {1: ["String"]}},
